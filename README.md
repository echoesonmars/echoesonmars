...
### ⚙️skills:
[![My Skills](https://skillicons.dev/icons?i=photoshop,figma,illustrator,mongodb,python,cpp,javascript,html,css,tailwindcss,nextjs,react,nodejs,typescript,postgres,fastapi)](https://skillicons.dev)

### 🌱learning:
[![My Skills](https://skillicons.dev/icons?i=pytorch,django,spring,rust)](https://skillicons.dev)
